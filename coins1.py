...
# function of program: 
# structure of program: The user should input the amount that should he pay , and the amount that he could paid 
#,then the program will do some maths if he have to paid more or should he return some coins.
    ...
    while change > 0 and coinValue > 0: #terwijl het wisselgeld groter is dan nul en de muntwaarde groter is dan nul
      ...
      if nrCoins > 0: #Als nrcoins groters is dan nul
        print('return maximal ', nrCoins, ' coins of ', coinValue, ' cents!' ) 
          #Schrijf retourmaximum (aantal munten) en muntenwaarde in centen
        nrCoinsReturned = int(float(input('How many coins of ' + str(coinValue) +  ' cents did you return? '))) 
          #invoer hoeveel munten heb je teruggegeven?
